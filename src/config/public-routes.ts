...
export const serviceDetailRoutes = {
  ...
  integrations: '/leistungen/integrationen-schnittstellen/',
  extensions: '/leistungen/plugin-extension-entwicklung/',
  productData: '/leistungen/produktdaten-datenfluesse/',
  customDevelopment: '/leistungen/individuelle-entwicklung/',
  operationsSupport: '/leistungen/betrieb-support/',
  hosting: '/leistungen/hosting/',
  updates: '/leistungen/updates/',
  recovery: '/leistungen/recovery/',
} as const;
...
export const publicRoutes: PublicRouteRecord[] = [
  ...
  { pathname: serviceDetailRoutes.shopwareEngineering, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.ecommerceConsulting, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.systemCheck, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  ...
  { pathname: serviceDetailRoutes.aiConsulting, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.integrations, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.extensions, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.productData, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.customDevelopment, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.operationsSupport, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.hosting, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.updates, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
  { pathname: serviceDetailRoutes.recovery, kind: 'service', stage: 'preview', indexable: false, includeInSitemap: false, includeInQa: true },
